// AI dev note: Barras horizontais de distribuição para o dashboard de conversas.
...
import type { DistribuicaoItem } from '@/types/whatsapp-conversas';

interface WhatsAppDistribuicaoBarrasProps {
  title: string;
  subtitle?: string;
...
const BAR_COLOR_MAP: Record<
  NonNullable<WhatsAppDistribuicaoBarrasProps['barColor']>,
  string
> = {
...
export const WhatsAppDistribuicaoBarras =
  React.memo<WhatsAppDistribuicaoBarrasProps>(
    ({
      title,
      subtitle,
      items,
...
WhatsAppDistribuicaoBarras.displayName = 'WhatsAppDistribuicaoBarras';
