...
import { ChevronDown, AlertTriangle, CheckCircle2, Info, Clock } from 'lucide-react';
...
export const EvaluationSectionContent: React.FC<EvaluationSectionContentProps> = ({
  secao,
  avaliacao,
  onChange,
  isReadOnly,
  ...
  const renderContent = () => {
    switch (secao.id) {
        ...
        return (
          <div className="space-y-6">
            ...
            <PatientRegistrationSection
              ...
              onObstetraChange={(obstetraId) => onChange({ obstetra_id: obstetraId })}
      ...
      case 'prenatal':
        ...
        const updateGestacao = (index: number, field: keyof GestacaoInfo, value: number | string | undefined) => {
          ...
          <div className="space-y-6">
            ...
            {!isGestacaoMultipla ? (
              ...
              <div className="space-y-4">
                <Label className="text-sm font-medium">Idade Gestacional de cada gestação</Label>
                  ...
                  {Array.from({ length: numGestacoes }).map((_, index) => (
                    <div key={index} className="flex items-center gap-2 p-3 bg-muted/30 rounded-lg">
                      ...
                      <Input
                        ...
                        min={20}
                        max={45}
                        value={gestacoes[index]?.idade_gestacional_semanas ?? ''}
                        onChange={(e) =>
                          updateGestacao(
                            index,
            ...
            <Field label="Líquido amniótico">
              <RadioButtonGroup
                ...
                onChange={(v) =>
                  onChange({
                    liquido_amniotico: v as AvaliacaoClinica['liquido_amniotico'],
                  })
                }
            ...
            <Field label="Apresentação fetal">
              <RadioButtonGroup
                ...
                onChange={(v) =>
                  onChange({
                    apresentacao_fetal: v as AvaliacaoClinica['apresentacao_fetal'],
                  })
                }
          ...
          <div className="space-y-6">
            ...
            <Field label="Instrumentos / Intervenções utilizados">
              <CheckboxGroup
                ...
                onChange={(v) => {
                  const instrumentos = v as AvaliacaoClinica['instrumentos_parto'];
                  ...
                  onChange({
                    ...
                    vacuo_extrator: instrumentos?.includes('vacuo_extrator') || false,
                  });
                }}
              ...
              {(!avaliacao.instrumentos_parto || avaliacao.instrumentos_parto.length === 0) && (
                <p className="text-xs text-muted-foreground mt-1">
              ...
              <div className="flex items-center gap-2">
                <Input
                  ...
                  value={
                    avaliacao.duracao_trabalho_parto_minutos
                      ? Math.floor(avaliacao.duracao_trabalho_parto_minutos / 60)
                      : ''
                  }
                  onChange={(e) => {
                    ...
                    onChange({
                      duracao_trabalho_parto_minutos: horas * 60 + minutosAtuais,
                    });
                  }}
                  disabled={isReadOnly}
                  placeholder="0"
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    onChange({
                      duracao_trabalho_parto_minutos: horasAtuais * 60 + minutos,
                    });
                  }}
                  disabled={isReadOnly}
                  placeholder="0"
          ...
          <div className="space-y-6">
            ...
            <Field label="Assistência ventilatória?">
              ...
              {avaliacao.assistencia_ventilatoria && (
                <div className="mt-4 space-y-4 p-4 bg-muted/30 rounded-lg border">
                  <Field label="Tipo(s) de assistência ventilatória">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                      {TIPOS_ASSISTENCIA_VENTILATORIA.map((tipo) => {
                        const tiposSelecionados = (avaliacao.tipos_assistencia_ventilatoria || []) as TipoAssistenciaVentilatoria[];
                        const isSelected = tiposSelecionados.includes(tipo.valor as TipoAssistenciaVentilatoria);
                          ...
                          <button
                            ...
                            onClick={() => {
                              ...
                              const novosValores = isSelected
                                ? tiposSelecionados.filter(v => v !== tipo.valor)
                                : [...tiposSelecionados, tipo.valor as TipoAssistenciaVentilatoria];
                              onChange({ tipos_assistencia_ventilatoria: novosValores });
                            }}
                            disabled={isReadOnly}
                            className={cn(
                  ...
                  {/* Campo para "Outro" */}
                  {((avaliacao.tipos_assistencia_ventilatoria || []) as TipoAssistenciaVentilatoria[]).includes('outro') && (
                    <Field label="Especifique outro tipo">
                      <Input
                        value={avaliacao.tipo_assistencia_ventilatoria_outro || ''}
                        onChange={(e) =>
                          onChange({ tipo_assistencia_ventilatoria_outro: e.target.value })
                        }
                        disabled={isReadOnly}
                  ...
                  <Field label="Tempo de assistência ventilatória">
                    <div className="flex items-center gap-2">
                      <Input
                        ...
                        min={0}
                        max={365}
                        value={avaliacao.tempo_assistencia_ventilatoria_dias ?? ''}
                        onChange={(e) =>
                          onChange({
            ...
            <Field label="Assimetrias percebidas">
              <CheckboxGroup
                ...
                onChange={(v) =>
                  onChange({ assimetrias_percebidas: v as AvaliacaoClinica['assimetrias_percebidas'] })
                }
          ...
          <div className="space-y-6">
            <Field label="Estado emocional geral">
              <CheckboxGroup
                ...
                onChange={(v) =>
                  onChange({ estado_emocional_opcoes: v as AvaliacaoClinica['estado_emocional_opcoes'] })
                }
            ...
            <Field label="Onde dorme">
              <RadioButtonGroup
                ...
                onChange={(v) =>
                  onChange({ onde_dorme_opcao: v as AvaliacaoClinica['onde_dorme_opcao'] })
                }
              ...
              {avaliacao.onde_dorme_opcao === 'outro' && (
                <Input
                  ...
                  onChange={(e) => onChange({ onde_dorme_outro: e.target.value })}
                  disabled={isReadOnly}
            ...
            <Field label="Qualidade do sono">
              <RadioButtonGroup
                ...
                onChange={(v) =>
                  onChange({ qualidade_sono_opcao: v as AvaliacaoClinica['qualidade_sono_opcao'] })
                }
            ...
            <Field label="Posição de preferência">
              <RadioButtonGroup
                ...
                onChange={(v) =>
                  onChange({ posicao_preferencia_opcao: v as AvaliacaoClinica['posicao_preferencia_opcao'] })
                }
            ...
            <Field label="Refluxo?">
              <RadioButtonGroup
                ...
                onChange={(v) => {
                  ...
                  onChange({ 
                    ...
                    refluxo: status === 'sim',
                    refluxo_tipo: status !== 'sim' ? null : avaliacao.refluxo_tipo,
                  });
                }}
              ...
              {avaliacao.refluxo_status === 'sim' && (
                <div className="mt-3 p-3 bg-muted/30 rounded-lg">
                  <Label className="text-xs text-muted-foreground mb-2 block">Tipo de refluxo:</Label>
                  <RadioButtonGroup
                    value={avaliacao.refluxo_tipo}
                    onChange={(v) =>
                      onChange({ refluxo_tipo: v as AvaliacaoClinica['refluxo_tipo'] })
                    }
            ...
            <Field label="Habilidades motoras presentes (idade de aparecimento)">
              <EvolutionEditor
                ...
                onChange={(value) =>
                  onChange({ habilidades_motoras: value })
                }
                disabled={isReadOnly}
      ...
      case 'marcos_motores':
        ...
        const marcosRelevantes = MARCOS_MOTORES.filter(
          (marco) => marco.idade_max_meses <= patientAgeInMonths || marco.idade_min_meses <= patientAgeInMonths
        );
        
        // Agrupa marcos por faixa etária
        const marcosPorFaixa = marcosRelevantes.reduce((acc, marco) => {
          if (!acc[marco.faixa]) {
            acc[marco.faixa] = [];
          }
        ...
        const marcosAtingidos = (avaliacao.marcos_motores_atingidos || {}) as MarcosMotoresAtingidos;
                  ...
                  <div className="divide-y">
                    {marcos.map((marco) => (
                      ...
                      >
                        ...
                        <span className={cn(
                          'text-sm',
                          marcosAtingidos[marco.id] && 'text-primary font-medium'
                        )}>
                          {marco.descricao}
                        </span>
                      </label>
      ...
      // =====================================================
      case 'torcicolo':
        const torc = (avaliacao.torcicolo_detalhado || {}) as TorcicoloDetalhado;
        ...
        const temNoduloDir = torc.ecom_direito_nodulo && torc.ecom_direito_nodulo !== 'ausente';
        const temNoduloEsq = torc.ecom_esquerdo_nodulo && torc.ecom_esquerdo_nodulo !== 'ausente';
        const temNodulo = temNoduloDir || temNoduloEsq;
        
        // Calcular grau automaticamente
        const grauCalculado = patientAgeInMonths 
          ? calcularGrauSeveridadeTorcicolo(patientAgeInMonths, deficitRotacao, !!temNodulo)
          : null;
        
        // Detectar inconsistências
        const inconsistencias = torc.tipo_clinico 
          ? detectarInconsistenciasTorcicolo(torc.tipo_clinico, deficitRotacao, !!temNodulo)
          : [];
        ...
        const updateTorcicolo = (updates: Partial<TorcicoloDetalhado>) => {
          onChange({
            ...
            tem_torcicolo: updates.tipo_clinico ? updates.tipo_clinico !== 'POST' || deficitRotacao > 0 : avaliacao.tem_torcicolo,
          });
        };
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">Classificação do Torcicolo</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Avalie a postura, realize a palpação do ECOM e classifique o tipo. O sistema calculará 
                    automaticamente o grau de severidade baseado nos dados coletados (idade, goniometria e presença de nódulo).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <span className="bg-purple-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm">A</span>
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                    {ATITUDE_CABECA_OPCOES.map((opt) => (
                      <button
                        key={opt.valor}
                        type="button"
                        onClick={() => !isReadOnly && updateTorcicolo({ atitude_cabeca: opt.valor as AtitudeCabeca })}
                        disabled={isReadOnly}
                        className={cn(
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{opt.descricao}</p>
                      </button>
                    ))}
                  </div>
                </Field>
                ...
                {torc.atitude_cabeca === 'atipica' && (
                  <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-200 dark:border-red-800">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium text-red-800 dark:text-red-200">⚠️ Red Flag - Investigar!</span>
                    </div>
                    <Textarea
                      value={torc.atitude_cabeca_obs || ''}
                      onChange={(e) => updateTorcicolo({ atitude_cabeca_obs: e.target.value })}
                      disabled={isReadOnly}
                ...
                <Field label="Elevação de Ombro">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateTorcicolo({ elevacao_ombro: v as ElevacaoOmbro })}
                    options={ELEVACAO_OMBRO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                    disabled={isReadOnly}
                  />
                </Field>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <span className="bg-orange-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm">B</span>
                  ...
                  <div className="space-y-3">
                    <Field label="Tônus">
                      <RadioButtonGroup
                        ...
                        onChange={(v) => updateTorcicolo({ ecom_direito_tonus: v as TonusECOM })}
                        options={TONUS_ECOM_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                        disabled={isReadOnly}
                      />
                    </Field>
                      ...
                      <RadioButtonGroup
                        ...
                        onChange={(v) => {
                          ...
                          updateTorcicolo({ 
                            ...
                            ecom_direito_nodulo_tamanho: loc === 'ausente' ? undefined : torc.ecom_direito_nodulo_tamanho
                          });
                        }}
                        options={LOCALIZACAO_NODULO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                        disabled={isReadOnly}
                      />
                    </Field>
                    ...
                    {temNoduloDir && (
                      <Field label="Tamanho do Nódulo">
                        <RadioButtonGroup
                          ...
                          onChange={(v) => updateTorcicolo({ ecom_direito_nodulo_tamanho: v as TamanhoNodulo })}
                          options={TAMANHO_NODULO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                          disabled={isReadOnly}
                        />
                      </Field>
                    )}
                  ...
                  <div className="space-y-3">
                    <Field label="Tônus">
                      <RadioButtonGroup
                        ...
                        onChange={(v) => updateTorcicolo({ ecom_esquerdo_tonus: v as TonusECOM })}
                        options={TONUS_ECOM_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                        disabled={isReadOnly}
                      />
                    </Field>
                      ...
                      <RadioButtonGroup
                        ...
                        onChange={(v) => {
                          ...
                          updateTorcicolo({ 
                            ...
                            ecom_esquerdo_nodulo_tamanho: loc === 'ausente' ? undefined : torc.ecom_esquerdo_nodulo_tamanho
                          });
                        }}
                        options={LOCALIZACAO_NODULO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                        disabled={isReadOnly}
                    ...
                    {temNoduloEsq && (
                      <Field label="Tamanho do Nódulo">
                        <RadioButtonGroup
                          ...
                          onChange={(v) => updateTorcicolo({ ecom_esquerdo_nodulo_tamanho: v as TamanhoNodulo })}
                          options={TAMANHO_NODULO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                          disabled={isReadOnly}
                        />
                      </Field>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              <h4 className="font-semibold mb-4 flex items-center gap-2">
                <span className="bg-green-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm">C</span>
                Diagnóstico Clínico
              </h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {TIPO_CLINICO_TORCICOLO_OPCOES.map((opt) => (
                    <button
                      key={opt.valor}
                      type="button"
                      onClick={() => !isReadOnly && updateTorcicolo({ tipo_clinico: opt.valor as TorcicoloTipoClinico })}
                      disabled={isReadOnly}
                      className={cn(
                        'p-3 rounded-lg border text-left transition-all',
              ...
              {torc.tipo_clinico === 'outros' && (
                <Field label="Especifique" className="mt-3">
                  <Input
                    ...
                    onChange={(e) => updateTorcicolo({ tipo_clinico_outros: e.target.value })}
                    disabled={isReadOnly}
              ...
              {torc.tipo_clinico && torc.tipo_clinico !== 'POST' && (
                <Field label="Lado Afetado" className="mt-3">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateTorcicolo({ lado_afetado: v as TorcicoloDetalhado['lado_afetado'] })}
                    options={[
            ...
            {inconsistencias.length > 0 && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 dark:border-yellow-700 rounded-lg p-4">
                ...
                {inconsistencias.map((msg, idx) => (
                  <p key={idx} className="text-sm text-yellow-700 dark:text-yellow-300 mb-1">
                    {msg}
                  </p>
                ))}
              </div>
              ...
              <div className={cn(
                ...
                <h4 className="font-semibold mb-3 flex items-center gap-2">
                  <CheckCircle2 className={cn(
                    'h-5 w-5',
                    grauCalculado.grau <= 3 ? 'text-green-600' : grauCalculado.grau <= 5 ? 'text-yellow-600' : 'text-red-600'
                  )} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Grau</span>
                    <p className="font-bold text-lg">{grauCalculado.descricao}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-500 dark:text-gray-400 flex items-center gap-1">
                      <Clock className="h-3 w-3" /> Tempo Est. Tratamento
                    </span>
                    <p className="font-medium">{grauCalculado.tempoTratamento}</p>
                  </div>
                  <div>
                    <span className="text-sm text-gray-500 dark:text-gray-400">Déficit Rotação</span>
                    <p className="font-medium">{deficitRotacao}° (da goniometria)</p>
                  </div>
                </div>
            ...
            <div className="border-t pt-6">
              <h4 className="font-semibold mb-4">Observação Postural Complementar</h4>
              ...
              <Field label="Observações" className="mt-4">
                <Textarea
                  ...
                  onChange={(e) => updateTorcicolo({ observacoes: e.target.value })}
                  disabled={isReadOnly}
            ...
            {avaliacao.assimetria_craniana && (
              <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-4">
                ...
                <p className="text-sm text-purple-700 dark:text-purple-300">
                  ...
                  Ex: Torcicolo com ECOM direito encurtado geralmente leva a plagiocefalia occipital direita.
                </p>
              </div>
            )}
          </div>
      ...
      case 'goniometria':
        ...
        const getReferenciaIdade = (idadeMeses: number) => {
          ...
          for (let i = 0; i < refs.length - 1; i++) {
            if (idadeMeses >= refs[i].idade_meses && idadeMeses < refs[i + 1].idade_meses) {
              const ratio = (idadeMeses - refs[i].idade_meses) / (refs[i + 1].idade_meses - refs[i].idade_meses);
              return {
                idade_meses: idadeMeses,
                rotacao_media: refs[i].rotacao_media + ratio * (refs[i + 1].rotacao_media - refs[i].rotacao_media),
                inclinacao_media: refs[i].inclinacao_media + ratio * (refs[i + 1].inclinacao_media - refs[i].inclinacao_media),
              };
            }
          }
        ...
        const rotAssimetria = rotDir !== null && rotEsq !== null ? Math.abs(rotDir - rotEsq) : null;
        const incAssimetria = incDir !== null && incEsq !== null ? Math.abs(incDir - incEsq) : null;
        const rotTotal = rotDir !== null && rotEsq !== null ? rotDir + rotEsq : null;
        const incTotal = incDir !== null && incEsq !== null ? incDir + incEsq : null;
        
        const rotClassificacao = rotAssimetria !== null ? classificarAssimetria(rotAssimetria) : null;
        const incClassificacao = incAssimetria !== null ? classificarAssimetria(incAssimetria) : null;
        
        const ladoRestritoRot = rotDir !== null && rotEsq !== null 
          ? (rotDir < rotEsq ? 'Direito' : rotDir > rotEsq ? 'Esquerdo' : 'Simétrico') 
          : null;
        const ladoRestritoInc = incDir !== null && incEsq !== null 
          ? (incDir < incEsq ? 'Direito' : incDir > incEsq ? 'Esquerdo' : 'Simétrico') 
          : null;
        ...
        const rotMenor = rotDir !== null && rotEsq !== null ? Math.min(rotDir, rotEsq) : null;
        const incMenor = incDir !== null && incEsq !== null ? Math.min(incDir, incEsq) : null;
        const rotPctNorma = rotMenor !== null ? Math.round((rotMenor / referencia.rotacao_media) * 100) : null;
        const incPctNorma = incMenor !== null ? Math.round((incMenor / referencia.inclinacao_media) * 100) : null;
        
        // Handler para atualizar valores
        const handleGonioChange = (
          tipo: 'rotacao' | 'inclinacao',
          campo: 'ativa_direita' | 'passiva_direita' | 'ativa_esquerda' | 'passiva_esquerda',
          valor: string
        ) => {
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                Avalia a <strong>amplitude de movimento (ADM)</strong> da coluna cervical. 
                O objetivo principal é <strong>identificar assimetrias</strong> entre os lados.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
                <div className="p-2 bg-blue-100/50 dark:bg-blue-900/30 rounded-lg">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300">
                    Movimento que o <strong>paciente realiza sozinho</strong>, sem ajuda externa. 
                    Reflete a força muscular e controle motor.
                  </p>
                </div>
                <div className="p-2 bg-blue-100/50 dark:bg-blue-900/30 rounded-lg">
                  <p className="font-medium text-sm text-blue-900 dark:text-blue-100 flex items-center gap-1">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-300">
                    Movimento que o <strong>examinador realiza</strong> no paciente. 
                    Reflete a flexibilidade articular e tecidual (mais importante para diagnóstico de TMC).
                  </p>
                </div>
              </div>
            ...
            <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-900">
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="text-green-700 dark:text-green-300">
                      ...
                      <th className="text-center py-1 px-2 font-medium">Rotação (média)</th>
                      <th className="text-center py-1 px-2 font-medium">Inclinação (média)</th>
                    </tr>
                  </thead>
                  <tbody className="text-green-800 dark:text-green-200">
                    {GONIOMETRIA_REFERENCIA_IDADE.map((ref) => (
                      <tr key={ref.idade_meses} className={cn(
                        "border-t border-green-200 dark:border-green-800",
                        idadeMeses >= ref.idade_meses - 1 && idadeMeses <= ref.idade_meses + 1 
                          ? "bg-green-100 dark:bg-green-900/50 font-medium" 
                          : ""
                      )}>
                        <td className="py-1 px-2">{ref.idade_meses} meses</td>
                        <td className="py-1 px-2 text-center">{ref.rotacao_media}°</td>
                        <td className="py-1 px-2 text-center">{ref.inclinacao_media}°</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              {idadeMeses > 0 && (
                <p className="text-xs text-green-600 dark:text-green-400 mt-2">
                  ...
                  Referência: Rotação ~{referencia.rotacao_media.toFixed(1)}° | Inclinação ~{referencia.inclinacao_media.toFixed(1)}°
                </p>
              )}
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-primary/10 px-4 py-2 border-b">
                <h5 className="font-semibold flex items-center gap-2">
                  <span>🔄</span>
                  Rotação Cervical
                  <span className="text-xs font-normal text-muted-foreground">(Norma ≈ {referencia.rotacao_media.toFixed(0)}°)</span>
                </h5>
              </div>
              <div className="p-4">
                ...
                <div className="grid grid-cols-5 gap-2 items-center py-2 border-t">
                  <div className="flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400 flex items-center justify-center text-xs font-bold">D</span>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('rotacao', 'ativa_direita', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                  ...
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('rotacao', 'passiva_direita', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <div className="text-center text-sm">
                    {rotDir !== null ? (
                      <span className={cn(
                        "font-medium",
                        (rotDir / referencia.rotacao_media) < 0.9 ? "text-red-500" : "text-green-500"
                      )}>
                ...
                <div className="grid grid-cols-5 gap-2 items-center py-2 border-t">
                  <div className="flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-purple-100 dark:bg-purple-900 text-purple-600 dark:text-purple-400 flex items-center justify-center text-xs font-bold">E</span>
                  ...
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('rotacao', 'ativa_esquerda', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('rotacao', 'passiva_esquerda', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <div className="text-center text-sm">
                    {rotEsq !== null ? (
                      <span className={cn(
                        "font-medium",
                        (rotEsq / referencia.rotacao_media) < 0.9 ? "text-red-500" : "text-green-500"
                      )}>
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div>
                        ...
                        <span className={cn("font-bold", 
                          rotClassificacao?.nivel === 'normal' ? "text-green-600" :
                          rotClassificacao?.nivel === 'leve' ? "text-yellow-600" :
                          rotClassificacao?.nivel === 'moderada' ? "text-orange-600" : "text-red-600"
                        )}>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-primary/10 px-4 py-2 border-b">
                <h5 className="font-semibold flex items-center gap-2">
                  <span>↔️</span>
                  Inclinação Lateral
                  <span className="text-xs font-normal text-muted-foreground">(Norma ≈ {referencia.inclinacao_media.toFixed(0)}°)</span>
                </h5>
              </div>
              <div className="p-4">
                <div className="grid grid-cols-5 gap-2 text-sm mb-2 text-center font-medium">
                ...
                <div className="grid grid-cols-5 gap-2 items-center py-2 border-t">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('inclinacao', 'ativa_direita', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('inclinacao', 'passiva_direita', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <div className="text-center text-sm">
                    {incDir !== null ? (
                      <span className={cn(
                        "font-medium",
                        (incDir / referencia.inclinacao_media) < 0.9 ? "text-red-500" : "text-green-500"
                      )}>
                        {Math.round((incDir / referencia.inclinacao_media) * 100)}%
                      </span>
                    ) : '—'}
                  </div>
                  <div className="text-center">
                ...
                <div className="grid grid-cols-5 gap-2 items-center py-2 border-t">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('inclinacao', 'ativa_esquerda', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <Input
                    ...
                    onChange={(e) => handleGonioChange('inclinacao', 'passiva_esquerda', e.target.value)}
                    disabled={isReadOnly}
                    placeholder="—"
                    className="h-8 text-center"
                  />
                  <div className="text-center text-sm">
                    {incEsq !== null ? (
                      <span className={cn(
                        "font-medium",
                        (incEsq / referencia.inclinacao_media) < 0.9 ? "text-red-500" : "text-green-500"
                      )}>
                        {Math.round((incEsq / referencia.inclinacao_media) * 100)}%
                      </span>
                    ) : '—'}
                  </div>
                  <div></div>
                  ...
                  <div className={cn(
                    ...
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <div>
                        <span className="font-medium">Assimetria: </span>
                        <span className={cn("font-bold", 
                          incClassificacao?.nivel === 'normal' ? "text-green-600" :
                          incClassificacao?.nivel === 'leve' ? "text-yellow-600" :
                          incClassificacao?.nivel === 'moderada' ? "text-orange-600" : "text-red-600"
                        )}>
              ...
              <div className="p-4 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Qualidade da Rotação">
                    <div className="grid grid-cols-2 gap-2">
                      {GONIOMETRIA_QUALIDADE_OPCOES.map((opt) => {
                        const isSelected = gonio.rotacao_qualidade === opt.valor;
                        return (
                          <button
                            key={opt.valor}
                            type="button"
                            onClick={() => !isReadOnly && onChange({
                              goniometria: { ...gonio, rotacao_qualidade: opt.valor as Goniometria['rotacao_qualidade'] }
                            })}
                            disabled={isReadOnly}
                            className={cn(
                  ...
                  <Field label="Qualidade da Inclinação">
                    <div className="grid grid-cols-2 gap-2">
                      {GONIOMETRIA_QUALIDADE_OPCOES.map((opt) => {
                        const isSelected = gonio.inclinacao_qualidade === opt.valor;
                        return (
                          <button
                            key={opt.valor}
                            type="button"
                            onClick={() => !isReadOnly && onChange({
                              goniometria: { ...gonio, inclinacao_qualidade: opt.valor as Goniometria['inclinacao_qualidade'] }
                            })}
                            disabled={isReadOnly}
                            className={cn(
                              "p-2 rounded-lg border-2 text-left transition-all",
                    ...
                    {GONIOMETRIA_SENSACAO_FINAL_OPCOES.map((opt) => {
                      ...
                      return (
                        <button
                          ...
                          type="button"
                          onClick={() => !isReadOnly && onChange({
                            goniometria: { ...gonio, sensacao_final: opt.valor as Goniometria['sensacao_final'] }
                          })}
                          disabled={isReadOnly}
                          className={cn(
              ...
              <div className="space-y-2">
                {rotClassificacao && rotClassificacao.nivel !== 'normal' && (
                  <div className={cn(
                    ...
                    rotClassificacao.nivel === 'leve' ? "bg-yellow-50 dark:bg-yellow-950/30 text-yellow-800 dark:text-yellow-200" :
                    rotClassificacao.nivel === 'moderada' ? "bg-orange-50 dark:bg-orange-950/30 text-orange-800 dark:text-orange-200" :
                    "bg-red-50 dark:bg-red-950/30 text-red-800 dark:text-red-200"
                  )}>
                    <span>⚠️</span>
                    <span className="text-sm">
                      <strong>Assimetria de Rotação {rotClassificacao.label}</strong> detectada ({rotAssimetria}°). 
                      Lado {ladoRestritoRot} apresenta restrição.
                    </span>
                  </div>
                )}
                {incClassificacao && incClassificacao.nivel !== 'normal' && (
                  <div className={cn(
                    "p-3 rounded-lg flex items-start gap-2",
                    incClassificacao.nivel === 'leve' ? "bg-yellow-50 dark:bg-yellow-950/30 text-yellow-800 dark:text-yellow-200" :
                    incClassificacao.nivel === 'moderada' ? "bg-orange-50 dark:bg-orange-950/30 text-orange-800 dark:text-orange-200" :
                    "bg-red-50 dark:bg-red-950/30 text-red-800 dark:text-red-200"
                  )}>
                    <span>⚠️</span>
                    <span className="text-sm">
                      <strong>Assimetria de Inclinação {incClassificacao.label}</strong> detectada ({incAssimetria}°). 
                      Lado {ladoRestritoInc} apresenta restrição.
                    </span>
                  </div>
                )}
                {rotPctNorma !== null && rotPctNorma < 90 && (
                  <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 text-amber-800 dark:text-amber-200 flex items-start gap-2">
                    <span>📉</span>
                    <span className="text-sm">
                      <strong>Hipo-mobilidade de Rotação:</strong> Lado mais restrito está em {rotPctNorma}% da norma esperada para a idade.
                    </span>
                  </div>
                )}
                {incPctNorma !== null && incPctNorma < 90 && (
                  <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 text-amber-800 dark:text-amber-200 flex items-start gap-2">
                    <span>📉</span>
                    <span className="text-sm">
                      <strong>Hipo-mobilidade de Inclinação:</strong> Lado mais restrito está em {incPctNorma}% da norma esperada para a idade.
                    </span>
                  </div>
                )}
              </div>
        ...
        const renderMFSButton = (
          ...
          return (
            <button
              key={pont.valor}
              type="button"
              onClick={() => !isReadOnly && onChange({ [`mfs_${lado}`]: pont.valor })}
              disabled={isReadOnly}
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                Avalia a <strong>força/resistência dos flexores laterais do pescoço</strong> através da 
                capacidade de retificação da cabeça quando o bebê é inclinado lateralmente.
              </p>
              
              <div className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
                <p className="flex items-start gap-2">
                  <span>📋</span>
                  <span><strong>Procedimento:</strong> Paciente suspenso, sair da posição vertical para horizontal</span>
                </p>
                <p className="flex items-start gap-2">
                  <span>⏱️</span>
                  <span><strong>Tempo:</strong> Aguardar 5 segundos para pontuar</span>
                </p>
                <p className="flex items-start gap-2">
                  <span>👶</span>
                  <span><strong>Idade:</strong> A partir de 2 meses</span>
                </p>
              </div>
            </div>
            ...
            <div className="p-3 bg-amber-50 dark:bg-amber-950/30 rounded-lg border border-amber-200 dark:border-amber-900">
              <p className="text-sm text-amber-800 dark:text-amber-200 flex items-start gap-2">
                <span>⚠️</span>
                <span>
                  <strong>Importante:</strong> Ao levar a criança para a <strong>direita</strong>, 
                  testamos os <strong>flexores esquerdos</strong>. O que encontramos de um lado, 
                  devemos encontrar do outro.
                </span>
              </p>
            </div>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              <h5 className="font-medium text-sm mb-3">Pontuação (0 a 5) - Ângulo de retificação da cabeça:</h5>
                ...
                {MFS_PONTUACAO.map((pont) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-[10px]">{pont.descricao}</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="text-green-700 dark:text-green-300">
                      <th className="text-left py-1 px-2 font-medium">Idade</th>
                      <th className="text-center py-1 px-2 font-medium">Média</th>
                      <th className="text-center py-1 px-2 font-medium">Variação</th>
                    </tr>
                  </thead>
                  <tbody className="text-green-800 dark:text-green-200">
                    {MFS_REFERENCIA_IDADE.map((ref) => (
                      <tr key={ref.idade} className="border-t border-green-200 dark:border-green-800">
                        <td className="py-1.5 px-2">{ref.idade}</td>
                        <td className="py-1.5 px-2 text-center font-medium">{ref.media}</td>
                        <td className="py-1.5 px-2 text-center">{ref.variacao}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="p-4 border rounded-lg bg-background">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {avaliacao.mfs_direito !== null && avaliacao.mfs_direito !== undefined && (
                ...
                <div className="flex gap-1">
                  {MFS_PONTUACAO.map((pont) => renderMFSButton('direito', pont, avaliacao.mfs_direito))}
                </div>
              </div>
              ...
              <div className="p-4 border rounded-lg bg-background">
                <div className="flex items-center justify-between mb-3">
                  ...
                  {avaliacao.mfs_esquerdo !== null && avaliacao.mfs_esquerdo !== undefined && (
                    <Badge variant="outline" className="text-lg font-bold">
                ...
                <div className="flex gap-1">
                  {MFS_PONTUACAO.map((pont) => renderMFSButton('esquerdo', pont, avaliacao.mfs_esquerdo))}
                </div>
              </div>
            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-2xl font-bold">
                      {(((avaliacao.mfs_direito ?? 0) + (avaliacao.mfs_esquerdo ?? 0)) / 2).toFixed(1)}
                    </p>
                  </div>
                </div>
              </div>
      ...
      // =====================================================
      case 'tensao':
        const tensaoData = (avaliacao.tensao_neuromeningea_detalhada || {}) as TensaoNeuromeningeaDetalhada;
        ...
        const handleTensaoChange = (
          ...
          const membroAtual = (tensaoData[membro] || {}) as TensaoNeuromeningeaAvaliacao;
          onChange({
        ...
        const assimetriaSuperior = 
          tensaoData.membro_superior_direito?.status !== tensaoData.membro_superior_esquerdo?.status &&
        ...
        const assimetriaInferior = 
          tensaoData.membro_inferior_direito?.status !== tensaoData.membro_inferior_esquerdo?.status &&
        ...
        const TensaoCard = ({ 
          ...
          const dados = (tensaoData[membro] || {}) as TensaoNeuromeningeaAvaliacao;
          const isAlterado = dados.status === 'alterado';
          
          return (
            <div className={cn(
              "border rounded-lg overflow-hidden",
              isAlterado ? "border-red-300 dark:border-red-800" : "border-border"
            )}>
              ...
              <div className="p-4 space-y-4">
                  ...
                  {['normal', 'alterado', 'nao_testado'].map((status) => {
                    ...
                    return (
                      <button
                        key={status}
                        type="button"
                        onClick={() => !isReadOnly && handleTensaoChange(membro, 'status', status)}
                        disabled={isReadOnly}
                        className={cn(
                ...
                {isAlterado && (
                  <div className="space-y-3 pt-2 border-t">
                    <p className="text-sm font-medium text-muted-foreground">O que foi observado?</p>
                    <div className="flex flex-wrap gap-2">
                      {TENSAO_SINTOMAS_OPCOES.map((sintoma) => {
                        const isSelected = (dados.sintomas || []).includes(sintoma.valor as TensaoNeuromeningeaSintoma);
                        return (
                          <button
                            key={sintoma.valor}
                            type="button"
                            onClick={() => !isReadOnly && handleSintomaToggle(membro, sintoma.valor as TensaoNeuromeningeaSintoma)}
                            disabled={isReadOnly}
                    ...
                    {/* End-Feel */}
                    <div className="pt-2">
                      <p className="text-sm font-medium text-muted-foreground mb-2">Sensação final (End-feel):</p>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                        {TENSAO_END_FEEL_OPCOES.map((opt) => {
                          ...
                          return (
                            <button
                              key={opt.valor}
                              type="button"
                              onClick={() => !isReadOnly && handleTensaoChange(membro, 'endFeel', opt.valor)}
                              disabled={isReadOnly}
                              className={cn(
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                Avalia a <strong>mobilidade do sistema nervoso</strong>. São testes provocativos onde 
                observamos a resposta do bebê ao alongamento das estruturas neurais.
              </p>
              ...
              <div className="p-3 bg-amber-50 dark:bg-amber-950/30 rounded-lg border border-amber-200 dark:border-amber-900">
                <p className="text-sm text-amber-800 dark:text-amber-200 flex items-start gap-2">
                  <span>👶</span>
                  <span>
                    <strong>Em pediatria (0-3 anos):</strong> O bebê não relata dor verbalmente. 
                    Observe: <strong>Choro</strong>, <strong>Resistência muscular</strong>, 
                    <strong>Retração do membro</strong> ou <strong>Expressão facial de dor</strong>.
                  </span>
                </p>
              </div>
            </div>
            ...
            <div>
              <h5 className="font-semibold mb-2 flex items-center gap-2">
                <span>💪</span>
                Membros Superiores
                <span className="text-xs font-normal text-muted-foreground">(Plexo Braquial / ULTT)</span>
              </h5>
              
              {/* Instruções do teste */}
              <div className="mb-3 p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-800 text-sm">
                <p className="font-medium text-slate-700 dark:text-slate-300 mb-1">📋 Como realizar:</p>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-500 mt-2 italic">
                  💡 Comparar sempre os dois lados. A diferença de resposta é mais importante que o resultado isolado.
                </p>
              </div>
            ...
            <div>
              <h5 className="font-semibold mb-2 flex items-center gap-2">
                <span>🦵</span>
                Membros Inferiores
                <span className="text-xs font-normal text-muted-foreground">(SLR - Elevação da Perna Estendida)</span>
              </h5>
              ...
              <div className="mb-3 p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-800 text-sm">
                ...
                <ol className="text-xs text-slate-600 dark:text-slate-400 space-y-1 ml-4 list-decimal">
                  ...
                  <li>Observe resistência, choro ou retração durante a elevação</li>
                </ol>
                <p className="text-xs text-slate-500 dark:text-slate-500 mt-2 italic">
                  💡 Normal: elevação livre até ~70-90°. Positivo se houver resistência precoce ou reação adversa.
                </p>
              </div>
            ...
            <div>
              <h5 className="font-semibold mb-2 flex items-center gap-2">
                <span>🧠</span>
                Neuroeixo
                <span className="text-xs font-normal text-muted-foreground">(Flexão Passiva do Pescoço)</span>
              </h5>
              ...
              <div className="mb-3 p-3 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-800 text-sm">
                ...
                <ol className="text-xs text-slate-600 dark:text-slate-400 space-y-1 ml-4 list-decimal">
                  ...
                  <li>Flexione passivamente o pescoço (queixo em direção ao peito)</li>
                  <li>Observe resistência, extensão dos membros ou choro</li>
                </ol>
                <p className="text-xs text-slate-500 dark:text-slate-500 mt-2 italic">
                  💡 Teste de tensão meníngea. Positivo se houver extensão reflexa dos membros ou resistência à flexão.
                </p>
              </div>
                ...
                {assimetriaSuperior && (
                  <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 flex items-start gap-2">
                    ...
                    <span className="text-sm text-amber-800 dark:text-amber-200">
                      <strong>Assimetria nos Membros Superiores:</strong> Respostas diferentes entre lados.
                    </span>
                  </div>
                )}
                {assimetriaInferior && (
                  <div className="p-3 rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 flex items-start gap-2">
                    <span>⚠️</span>
                    <span className="text-sm text-amber-800 dark:text-amber-200">
                      <strong>Assimetria nos Membros Inferiores:</strong> Respostas diferentes entre lados.
                    </span>
                  </div>
                )}
              </div>
            ...
            {temTestePositivo && avaliacao.goniometria && (
              <div className="p-4 bg-indigo-50 dark:bg-indigo-950/30 rounded-lg border border-indigo-200 dark:border-indigo-900">
                ...
                <p className="text-sm text-indigo-800 dark:text-indigo-200">
                  A restrição de movimento pode possuir <strong>componente neural</strong>. 
                  O tratamento deve incluir <strong>mobilização neural suave</strong>, não apenas muscular.
                </p>
              </div>
            )}
      ...
      case 'sensoriais':
        ...
        const SelectButton = ({ 
          ...
          opcoes: readonly { valor: string; label: string; descricao?: string; icone?: string }[];
        ...
        // Detectar alertas
        const alertaVisualRestrito = funcoes.visual?.rastreio_visual && funcoes.visual.rastreio_visual !== 'simetrico';
        const alertaRespiradorOral = funcoes.oral?.vedamento_labial === 'labios_abertos';
        const alertaFrenuloCurto = funcoes.oral?.anatomia_lingua && funcoes.oral.anatomia_lingua !== 'normal';
        const alertaCoordenacao = funcoes.oral?.coordenacao_sdr && funcoes.oral.coordenacao_sdr !== 'coordenada';
        const alertaSustoExacerbado = funcoes.auditiva?.reacao_ruidos === 'susto_exacerbado';
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200">
                Avalia as funções <strong>visual</strong>, <strong>oral</strong> e <strong>auditiva</strong>. 
                Importante para identificar assimetrias que influenciam no torcicolo e na respiração.
              </p>
            </div>
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-purple-50 dark:bg-purple-950/30 px-4 py-3 border-b">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Se o bebê não olha para um lado, não vai alongar o pescoço para o outro
                </p>
              </div>
              <div className="p-4 space-y-4">
                <Field label="Rastreio Visual (Campo Visual)">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('visual', 'rastreio_visual', v)}
                    disabled={isReadOnly}
                  />
                  {alertaVisualRestrito && (
                    <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center gap-1">
                      <span>⚠️</span>
                      Restrição visual pode indicar preferência de posição ou torcicolo
                    </p>
                  )}
                </Field>
                ...
                <Field label="Contato Visual">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('visual', 'contato_visual', v)}
                    disabled={isReadOnly}
                  />
                </Field>
                ...
                <Field label="Alinhamento Ocular (Estrabismo)">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('visual', 'alinhamento_ocular', v)}
                    disabled={isReadOnly}
                  />
                </Field>
                ...
                <Field label="Observações">
                  <Textarea
                    ...
                    onChange={(e) => handleFuncoesChange('visual', 'observacoes', e.target.value)}
                    disabled={isReadOnly}
            ...
            <div className="border rounded-lg overflow-hidden">
              <div className="bg-pink-50 dark:bg-pink-950/30 px-4 py-3 border-b">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Qualidade da mamada e anatomia oral - impacto na respiração e tensão cervical
                </p>
              </div>
              <div className="p-4 space-y-4">
                <Field label="Vedamento Labial (Repouso)">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('oral', 'vedamento_labial', v)}
                    disabled={isReadOnly}
                  />
                  {alertaRespiradorOral && (
                    <p className="text-xs text-red-600 dark:text-red-400 mt-2 flex items-center gap-1">
                      <span>🚨</span>
                      <strong>Respirador Oral!</strong> Importante para fisioterapia respiratória
                    </p>
                  )}
                </Field>
                ...
                <Field label="Língua (Anatomia)">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('oral', 'anatomia_lingua', v)}
                    disabled={isReadOnly}
                  />
                  {alertaFrenuloCurto && (
                    <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center gap-1">
                      <span>⚠️</span>
                      Língua presa pode causar tensão na fáscia cervical anterior
                    </p>
                  )}
                </Field>
                
                {/* Mostrar campo de frenectomia se houver alteração na língua */}
                {funcoes.oral?.anatomia_lingua && funcoes.oral.anatomia_lingua !== 'normal' && (
                  <Field label="Frenectomia (Cirurgia de frênulo)">
                    <SelectButton
                      opcoes={FRENECTOMIA_OPCOES}
                      valor={funcoes.oral?.frenectomia}
                      onChange={(v) => handleFuncoesChange('oral', 'frenectomia', v)}
                      disabled={isReadOnly}
                    />
                ...
                <Field label="Coordenação S/D/R (Sucção/Deglutição/Respiração)">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('oral', 'coordenacao_sdr', v)}
                    disabled={isReadOnly}
                  />
                  {alertaCoordenacao && (
                    <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center gap-1">
                      <span>⚠️</span>
                      Descoordenação pode indicar disfagia ou imaturidade neuromotora
                    </p>
                  )}
                </Field>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Reflexo de Busca">
                    <RadioButtonGroup
                      ...
                      onChange={(v) => handleFuncoesChange('oral', 'reflexo_busca', v)}
                      options={[
                  ...
                  <Field label="Reflexo de Vômito (Gag)">
                    <SelectButton
                      ...
                      onChange={(v) => handleFuncoesChange('oral', 'reflexo_gag', v)}
                      disabled={isReadOnly}
                    />
                  </Field>
                </div>
                ...
                <Field label="Observações">
                  <Textarea
                    ...
                    onChange={(e) => handleFuncoesChange('oral', 'observacoes', e.target.value)}
                    disabled={isReadOnly}
              ...
              <div className="p-4 space-y-4">
                <Field label="Localização Sonora">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('auditiva', 'localizacao_sonora', v)}
                    disabled={isReadOnly}
                  />
                </Field>
                ...
                <Field label="Reação a Ruídos">
                  <SelectButton
                    ...
                    onChange={(v) => handleFuncoesChange('auditiva', 'reacao_ruidos', v)}
                    disabled={isReadOnly}
                  />
                  {alertaSustoExacerbado && (
                    <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center gap-1">
                      <span>⚠️</span>
                      Moro intenso pode indicar sistema nervoso autônomo em alerta/estressado
                    </p>
                  )}
                </Field>
                ...
                <Field label="Observações">
                  <Textarea
                    ...
                    onChange={(e) => handleFuncoesChange('auditiva', 'observacoes', e.target.value)}
                    disabled={isReadOnly}
            ...
            {/* Alertas Resumidos */}
            {(alertaVisualRestrito || alertaRespiradorOral || alertaFrenuloCurto || alertaCoordenacao || alertaSustoExacerbado) && (
                ...
                <ul className="text-sm text-amber-700 dark:text-amber-300 space-y-1">
                  {alertaVisualRestrito && (
                    <li className="flex items-center gap-2">
                      <span>👁️</span>
                      Rastreio visual restrito à {funcoes.visual?.rastreio_visual === 'restrito_direita' ? 'direita' : 'esquerda'}
                    </li>
                  )}
                  {alertaRespiradorOral && (
                    <li className="flex items-center gap-2">
                  ...
                  {alertaFrenuloCurto && (
                    <li className="flex items-center gap-2">
                      <span>👅</span>
                      Alteração de frênulo lingual ({funcoes.oral?.anatomia_lingua === 'frenulo_curto' ? 'curto' : 'em coração'})
                    </li>
                  )}
                  {alertaCoordenacao && (
                    <li className="flex items-center gap-2">
                      <span>🍼</span>
                      Descoordenação S/D/R ({funcoes.oral?.coordenacao_sdr === 'cansaco_pausas' ? 'cansaço/pausas' : 'engasgos/tosse'})
                    </li>
                  )}
                  {alertaSustoExacerbado && (
                    <li className="flex items-center gap-2">
      ...
      // =====================================================
      case 'craniometria':
        const medidas = (avaliacao.medidas_craniometricas || {}) as MedidasCraniometricas;
        ...
        const updateMedidas = (updates: Partial<MedidasCraniometricas>) => {
          ...
          onChange({
            medidas_craniometricas: {
              ...
              plagiocefalia_severidade: novasMetricas.plagiocefalia_severidade ?? undefined,
              braquicefalia_severidade: novasMetricas.braquicefalia_severidade ?? undefined,
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-2">
                <Info className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">Cefalometria Completa</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Use o craniômetro para medir as diagonais e dimensões. O sistema calculará automaticamente
                    o CVA (assimetria), CVAI (índice de plagiocefalia) e CI (índice cefálico para braquicefalia).
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
              <input
                ...
                onChange={(e) => updateMedidas({ pontos_marcados_fita: e.target.checked })}
                disabled={isReadOnly}
                className="rounded"
              />
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Meça as diagonais cruzadas do crânio. Diagonal A: Testa Esq → Nuca Dir. Diagonal B: Testa Dir → Nuca Esq.
              </p>
                ...
                <Field label="Diagonal A (mm)">
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => updateMedidas({ 
                        diagonal_a_mm: e.target.value ? parseFloat(e.target.value) : undefined 
                      })}
                      disabled={isReadOnly}
                      placeholder="Ex: 145"
                      className="pr-12"
                ...
                <Field label="Diagonal B (mm)">
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => updateMedidas({ 
                        diagonal_b_mm: e.target.value ? parseFloat(e.target.value) : undefined 
                      })}
                      disabled={isReadOnly}
                      placeholder="Ex: 135"
                      className="pr-12"
              ...
              {(medidas.diagonal_a_mm && medidas.diagonal_b_mm) && (
                <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div>
                      <span className="text-xs text-gray-500">CVA (Assimetria)</span>
                      <p className="font-bold text-lg">{metricasCalculadas.cva_mm?.toFixed(1)} mm</p>
                    </div>
                    <div>
                      <span className="text-xs text-gray-500">CVAI (Índice)</span>
                      <div className="flex items-center gap-2">
                        <p className="font-bold text-lg">{metricasCalculadas.cvai_percentual?.toFixed(2)}%</p>
                        {metricasCalculadas.plagiocefalia_severidade && (
                          <Badge className={cn(
                            'text-white',
                            getCorPlagiocefalia(metricasCalculadas.cvai_percentual)
                          )}>
                            {PLAGIOCEFALIA_CLASSIFICACAO.find(p => p.severidade === metricasCalculadas.plagiocefalia_severidade)?.label}
                          </Badge>
                        )}
                      </div>
                    </div>
                    <div className="col-span-2 md:col-span-1">
                      ...
                      <p className="font-medium">
                        {PLAGIOCEFALIA_CLASSIFICACAO.find(p => p.severidade === metricasCalculadas.plagiocefalia_severidade)?.emoji}{' '}
                        Nível {PLAGIOCEFALIA_CLASSIFICACAO.find(p => p.severidade === metricasCalculadas.plagiocefalia_severidade)?.nivel || '-'}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Comprimento: Glabela (entre sobrancelhas) → Opistocrânio (ponto mais posterior). 
                Largura: Eurion → Eurion (parte mais larga, acima das orelhas).
              </p>
                ...
                <Field label="Comprimento AP (mm)">
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => updateMedidas({ 
                        comprimento_ap_mm: e.target.value ? parseFloat(e.target.value) : undefined 
                      })}
                      disabled={isReadOnly}
                      placeholder="Ex: 120"
                      className="pr-12"
                ...
                <Field label="Largura ML (mm)">
                  <div className="relative">
                    <Input
                      ...
                      onChange={(e) => updateMedidas({ 
                        largura_ml_mm: e.target.value ? parseFloat(e.target.value) : undefined 
                      })}
                      disabled={isReadOnly}
                      placeholder="Ex: 110"
                      className="pr-12"
              ...
              {(medidas.comprimento_ap_mm && medidas.largura_ml_mm) && (
                <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <span className="text-xs text-gray-500">CI (Índice Cefálico)</span>
                      <div className="flex items-center gap-2">
                        <p className="font-bold text-lg">{metricasCalculadas.ci_percentual?.toFixed(1)}%</p>
                        {metricasCalculadas.braquicefalia_severidade && (
                          <Badge className={cn(
                            'text-white',
                            getCorBraquicefalia(metricasCalculadas.ci_percentual)
                          )}>
                            {BRAQUICEFALIA_CLASSIFICACAO.find(b => b.severidade === metricasCalculadas.braquicefalia_severidade)?.label}
                          </Badge>
                        )}
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="font-medium text-sm">
                        {BRAQUICEFALIA_CLASSIFICACAO.find(b => b.severidade === metricasCalculadas.braquicefalia_severidade)?.descricao}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <Field label="Perímetro Cefálico (cm)">
                <div className="relative w-40">
                  <Input
                    ...
                    onChange={(e) => updateMedidas({ 
                      perimetro_cefalico_cm: e.target.value ? parseFloat(e.target.value) : undefined 
                    })}
                    disabled={isReadOnly}
                    placeholder="Ex: 42.5"
                    className="pr-12"
            ...
            {metricasCalculadas.formato_craniano !== 'normal' && (
              <div className={cn(
                ...
                <h4 className="font-semibold mb-2">
                  Formato Craniano: {metricasCalculadas.formato_craniano.toUpperCase()}
                </h4>
                <p className="text-sm">
                  {metricasCalculadas.formato_craniano === 'plagiocefalia' && 'Assimetria craniana detectada. Foco no reposicionamento e alongamento cervical.'}
                  {metricasCalculadas.formato_craniano === 'braquicefalia' && 'Cabeça achatada posteriormente. Foco em tummy time e variedade de posições.'}
                  {metricasCalculadas.formato_craniano === 'escafocefalia' && 'Cabeça alongada. Avaliar histórico de posicionamento lateral.'}
                  {metricasCalculadas.formato_craniano === 'misto' && 'Combinação de plagiocefalia + alteração de formato. Tratamento multifocal necessário.'}
                </p>
              </div>
            )}
            ...
            <details className="bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <div className="p-4 pt-0 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h5 className="font-medium text-sm mb-2">Plagiocefalia (CVAI)</h5>
                  <div className="space-y-1">
                    {PLAGIOCEFALIA_CLASSIFICACAO.map((n) => (
                      <div key={n.nivel} className="flex items-center gap-2 text-xs">
                        ...
                        <span>Nível {n.nivel}: {n.label} ({n.cvai_min}% - {n.cvai_max}%)</span>
                      </div>
                    ))}
                  </div>
                </div>
                <div>
                  <h5 className="font-medium text-sm mb-2">Braquicefalia (CI)</h5>
                  <div className="space-y-1">
                    {BRAQUICEFALIA_CLASSIFICACAO.map((n) => (
                      <div key={n.severidade} className="flex items-center gap-2 text-xs">
                        <span className={cn('w-3 h-3 rounded-full', n.cor)} />
                        <span>{n.label} ({n.ci_min}% - {n.ci_max}%)</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      // =====================================================
      case 'assimetria':
        const assimetria = (avaliacao.assimetria_craniana || {}) as AssimetriaCraniana;
        ...
        return (
          <div className="space-y-6">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {medidasCranio.cvai_percentual != null && (
                    <div>
                      <span className="text-xs text-gray-500">Plagiocefalia (CVAI)</span>
                      <div className="flex items-center gap-2">
                        <Badge className={cn('text-white', getCorPlagiocefalia(medidasCranio.cvai_percentual))}>
                          {medidasCranio.cvai_percentual.toFixed(1)}%
                        </Badge>
                        <span className="text-sm font-medium">
                          {PLAGIOCEFALIA_CLASSIFICACAO.find(p => p.severidade === medidasCranio.plagiocefalia_severidade)?.label}
                        </span>
                      </div>
                    </div>
                  )}
                  {medidasCranio.ci_percentual != null && (
                    <div>
                      <span className="text-xs text-gray-500">Forma da Cabeça (CI)</span>
                      <div className="flex items-center gap-2">
                        <Badge className={cn('text-white', getCorBraquicefalia(medidasCranio.ci_percentual))}>
                          {medidasCranio.ci_percentual.toFixed(1)}%
                        </Badge>
                        <span className="text-sm font-medium">
                          {BRAQUICEFALIA_CLASSIFICACAO.find(b => b.severidade === medidasCranio.braquicefalia_severidade)?.label}
                        </span>
                      </div>
                    </div>
                  )}
                  {medidasCranio.formato_craniano && (
                    <div>
                      ...
                      <p className="font-medium capitalize">{medidasCranio.formato_craniano}</p>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Avaliação complementar para confirmar se a assimetria afetou a base do crânio e face.
              </p>
              ...
              <div className="space-y-4">
                ...
                <Field label="Desalinhamento das Orelhas (Ear Shift)">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateAssimetria({ ear_shift: v as EarShift })}
                    options={EAR_SHIFT_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                    disabled={isReadOnly}
                  />
                  {assimetria.ear_shift && assimetria.ear_shift !== 'alinhadas' && (
                    <div className="mt-2">
                      <Field label="Qual orelha está anteriorizada?">
                        <RadioButtonGroup
                          value={assimetria.ear_shift_lado}
                          onChange={(v) => updateAssimetria({ ear_shift_lado: v as 'direita' | 'esquerda' })}
                          options={[
                            { valor: 'direita', label: 'Direita' },
                            { valor: 'esquerda', label: 'Esquerda' },
                          ]}
                ...
                {assimetria.ear_shift === 'maior_5mm' && (
                  <div className="bg-yellow-50 dark:bg-yellow-900/20 p-3 rounded-lg border border-yellow-300">
                    <p className="text-sm text-yellow-800 dark:text-yellow-200 flex items-center gap-2">
                      ...
                      Desalinhamento maior que 5mm indica que a assimetria afetou a base do crânio.
                      Tratamento pode ser mais prolongado.
                    </p>
                  </div>
                )}
                ...
                <Field label="Bossing Frontal (Proeminência da Testa)">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateAssimetria({ bossing_frontal: v as BossingFrontal })}
                    options={BOSSING_FRONTAL_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                    disabled={isReadOnly}
                  />
                  {assimetria.bossing_frontal && assimetria.bossing_frontal !== 'ausente' && assimetria.bossing_frontal !== 'bilateral' && (
                    <div className="mt-2">
                      <Field label="Qual lado está proeminente?">
                        <RadioButtonGroup
                          value={assimetria.bossing_frontal_lado}
                          onChange={(v) => updateAssimetria({ bossing_frontal_lado: v as 'direita' | 'esquerda' })}
                          options={[
                            { valor: 'direita', label: 'Direita' },
                            { valor: 'esquerda', label: 'Esquerda' },
                          ]}
                ...
                {assimetria.assimetria_facial && (
                  <Field label="Descreva a assimetria facial">
                    <Textarea
                      ...
                      onChange={(e) => updateAssimetria({ assimetria_facial_descricao: e.target.value })}
                      disabled={isReadOnly}
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <CheckboxGroup
                ...
                onChange={(v) => updateAssimetria({ outras: v as AssimetriaCraniana['outras'] })}
            ...
            <Field label="Observações">
              <Textarea
                ...
                onChange={(e) => updateAssimetria({ observacoes: e.target.value })}
                disabled={isReadOnly}
      ...
      case 'fsos2':
        ...
        const calcularSubtotalPosicao = (posicaoData: FSOS2ItemsPorPosicao | undefined): number => {
        ...
        const scoreTotal = subtotais.supino + subtotais.prono + subtotais.sentado + subtotais.em_pe;
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-900">
              ...
              <p className="text-sm text-blue-800 dark:text-blue-200 mb-3">
                Avalia o <strong>quão simétrico</strong> está o comportamento motor do bebê em cada posição. 
                Observa se os movimentos são iguais dos dois lados, se há preferência de um lado, 
                e se existem padrões posturais ou motores assimétricos.
              </p>
              <p className="text-xs text-blue-700 dark:text-blue-300 italic">
                💡 Dica: Observe por pelo menos 1-2 minutos por posição, sem interferir demais no movimento natural.
              </p>
            </div>
            ...
            <div className="p-3 bg-muted/50 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-2">
                {FSOS2_PONTUACAO.map((pont) => (
                  <div key={pont.valor} className="text-xs p-2 bg-background rounded border">
                    <span className="font-bold text-primary">{pont.valor}</span>
                    <span className="text-muted-foreground ml-1">- {pont.label.split(' - ')[1]}</span>
                    <p className="text-muted-foreground/70 mt-0.5 text-[10px]">{pont.descricao}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            {FSOS2_POSICOES.map((posicao) => {
              const posicaoData = (fsos[posicao.id as keyof FSOS2] || {}) as FSOS2ItemsPorPosicao;
                ...
                >
                  <summary className="w-full flex items-center justify-between px-4 py-3 text-base font-semibold hover:bg-muted/50 cursor-pointer list-none">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge 
                        variant={porcentagem >= 75 ? 'default' : porcentagem >= 50 ? 'secondary' : 'destructive'}
                        className="ml-2"
                      >
                  ...
                  <div className="border-t">
                    <div className="divide-y">
                      {FSOS2_ITENS.map((item, index) => {
                        const valorAtual = posicaoData[item.id as keyof FSOS2ItemsPorPosicao] as number | undefined;
                        return (
                          <div 
                            key={item.id} 
                            className={cn(
                              ...
                              <div className="flex gap-1 ml-7 md:ml-0">
                                {FSOS2_PONTUACAO.map((pont) => (
                                  <button
                                    key={pont.valor}
                                    type="button"
                                    onClick={() => !isReadOnly && handleFSOS2Change(
                                      posicao.id as 'supino' | 'prono' | 'sentado' | 'em_pe',
                                      item.id,
                                      pont.valor
                                    )}
                                    disabled={isReadOnly}
            ...
            <div className="p-4 bg-gradient-to-r from-primary/10 to-primary/5 rounded-lg border border-primary/20">
                ...
                <div className="h-3 bg-muted rounded-full overflow-hidden">
                  <div 
                    className={cn(
                      ...
                      scoreTotal >= 84 ? "bg-green-500" : 
                      scoreTotal >= 56 ? "bg-yellow-500" : "bg-red-500"
                    )}
              ...
              <div className="grid grid-cols-4 gap-2 mt-4">
                {FSOS2_POSICOES.map((posicao) => {
                  const subtotal = subtotais[posicao.id as keyof typeof subtotais];
                  return (
                    <div key={posicao.id} className="text-center p-2 bg-background rounded">
                      <p className="text-lg">{posicao.icone}</p>
                      <p className="text-xs text-muted-foreground">{posicao.label}</p>
      ...
      // =====================================================
      case 'funcionalidade':
        const func = (avaliacao.funcionalidade_cervical || {}) as FuncionalidadeCervical;
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-2">
                <Info className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">Controle Motor Cervical</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Avalie a biomecânica e controle motor do bebê. Foco: "Ele segura a cabeça no meio?" e "Ele empurra o chão de bruços?".
                    Crucial para plagiocefalia - se não mantém no meio, a cabeça amassa.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {MANUTENCAO_LINHA_MEDIA_OPCOES.map((opt) => (
                      <button
                        key={opt.valor}
                        type="button"
                        onClick={() => !isReadOnly && updateFunc({ 
                          supino: { ...func.supino, manutencao_linha_media: opt.valor as ManutencaoLinhaMeadia } 
                        })}
                        disabled={isReadOnly}
                        className={cn(
                          'p-3 rounded-lg border text-left transition-all',
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-500 mt-1">{opt.descricao}</p>
                      </button>
                    ))}
                  </div>
                  {func.supino?.manutencao_linha_media === 'cai_preferencia' && (
                    <p className="text-xs text-yellow-600 mt-2 flex items-center gap-1">
                      <AlertTriangle className="h-3 w-3" /> Preferência postural pode agravar plagiocefalia
                    </p>
                  )}
                </Field>
                ...
                <Field label="Alcance de Linha Média (Mãos)">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateFunc({ 
                      supino: { ...func.supino, alcance_linha_media: v as AlcanceLinhaMeadia } 
                    })}
                    options={ALCANCE_LINHA_MEDIA_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                    disabled={isReadOnly}
                  />
                </Field>
                ...
                <Field label="Observações (Supino)">
                  <Textarea
                    ...
                    onChange={(e) => updateFunc({ supino: { ...func.supino, observacoes: e.target.value } })}
                    disabled={isReadOnly}
                    rows={2}
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {TOLERANCIA_TUMMY_TIME_OPCOES.map((opt) => (
                      <button
                        ...
                        type="button"
                        onClick={() => !isReadOnly && updateFunc({ 
                          prono: { ...func.prono, tolerancia: opt.valor as ToleranciaTummyTime } 
                        })}
                        disabled={isReadOnly}
                        className={cn(
                          'p-3 rounded-lg border text-left transition-all',
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <Field label="Carga de Peso (Apoio)">
                    <RadioButtonGroup
                      ...
                      onChange={(v) => updateFunc({ 
                        prono: { ...func.prono, carga_peso: v as CargaPesoProno } 
                      })}
                      options={CARGA_PESO_PRONO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                      disabled={isReadOnly}
                    />
                  </Field>
                  ...
                  <Field label="Controle de Cabeça">
                    <RadioButtonGroup
                      ...
                      onChange={(v) => updateFunc({ 
                        prono: { ...func.prono, controle_cabeca: v as ControleCabecaProno } 
                      })}
                      options={CONTROLE_CABECA_PRONO_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                      disabled={isReadOnly}
                    />
                  </Field>
                </div>
                ...
                <Field label="Observações (Prono)">
                  <Textarea
                    ...
                    onChange={(e) => updateFunc({ prono: { ...func.prono, observacoes: e.target.value } })}
                    disabled={isReadOnly}
                    rows={2}
            ...
            {func.prono?.tolerancia === 'chora_imediato' && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 rounded-lg p-4">
                <p className="text-sm text-yellow-800 dark:text-yellow-200 flex items-center gap-2">
                  <AlertTriangle className="h-4 w-4" />
                  <strong>Dica:</strong> Bebês que rejeitam tummy time tendem a desenvolver plagiocefalia.
                  Oriente os pais sobre técnicas graduais de adaptação.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-2">
                <Info className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">Testes Provocativos (30 segundos)</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Avaliação rápida de tônus e controle neuromotor. O Teste de Tração é o principal indicador de atraso motor.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Segure os punhos do bebê e puxe-o lentamente para sentar. Observe se a cabeça acompanha ou fica para trás.
              </p>
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {HEAD_LAG_OPCOES.map((opt) => (
                      <button
                        key={opt.valor}
                        type="button"
                        onClick={() => !isReadOnly && updateResp({ 
                          tracao: { ...resp.tracao, head_lag: opt.valor as HeadLag } 
                        })}
                        disabled={isReadOnly}
                        className={cn(
                          'p-3 rounded-lg border text-left transition-all',
                ...
                {resp.tracao?.head_lag === 'total' && (
                  <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-300">
                    <p className="text-sm text-red-800 dark:text-red-200 flex items-center gap-2">
                      <AlertTriangle className="h-4 w-4" />
                      <strong>RED FLAG:</strong> Head lag total após 4 meses pode indicar hipotonia significativa. 
                      Considere avaliação neurológica complementar.
                    </p>
                  </div>
                )}
                ...
                <Field label="Ativação de Flexores">
                  <RadioButtonGroup
                    ...
                    onChange={(v) => updateResp({ 
                      tracao: { ...resp.tracao, ativacao_flexores: v as AtivacaoFlexores } 
                    })}
                    options={ATIVACAO_FLEXORES_OPCOES.map(o => ({ valor: o.valor, label: o.label }))}
                    disabled={isReadOnly}
                  />
                </Field>
                ...
                <Field label="Observações">
                  <Textarea
                    ...
                    onChange={(e) => updateResp({ tracao: { ...resp.tracao, observacoes: e.target.value } })}
                    disabled={isReadOnly}
                    rows={2}
            ...
            <div className="bg-white dark:bg-gray-800 border rounded-lg p-4">
              ...
              <p className="text-xs text-gray-500 mb-4">
                Suspenda o bebê horizontalmente pela barriga. O padrão normal é "aviãozinho" com extensão de cabeça, tronco e pernas.
              </p>
              ...
              <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                    {PADRAO_LANDAU_OPCOES.map((opt) => (
                      <button
                        ...
                        type="button"
                        onClick={() => !isReadOnly && updateResp({ 
                          landau: { ...resp.landau, padrao: opt.valor as PadraoLandau } 
                        })}
                        disabled={isReadOnly}
                        className={cn(
                          'p-3 rounded-lg border text-left transition-all',
                ...
                {resp.landau?.padrao === 'hipotonico' && (
                  <div className="bg-red-50 dark:bg-red-900/20 p-3 rounded-lg border border-red-300">
                    <p className="text-sm text-red-800 dark:text-red-200 flex items-center gap-2">
                      <AlertTriangle className="h-4 w-4" />
                      Padrão hipotônico (U invertido) indica baixo tônus muscular. 
                      Investigar causas e fortalecer musculatura extensora.
                    </p>
                  </div>
                )}
                ...
                <Field label="Observações">
                  <Textarea
                    ...
                    onChange={(e) => updateResp({ landau: { ...resp.landau, observacoes: e.target.value } })}
                    disabled={isReadOnly}
                    rows={2}
            ...
            <Field label="Repercussões em tronco/membros">
              <Textarea
                value={resp.repercussoes_tronco_membros || avaliacao.repercussoes_tronco_membros || ''}
                onChange={(e) => updateResp({ repercussoes_tronco_membros: e.target.value })}
                disabled={isReadOnly}
                rows={3}
      ...
      // =====================================================
      case 'aims':
        const aimsDetalhada = (avaliacao.aims_detalhada || { itens_marcados: {} }) as AIMSDetalhada;
        ...
        const calcularScoresAIMS = (itens: Record<string, boolean>) => {
          ...
          return { prono, supino, sentado, em_pe, total: prono + supino + sentado + em_pe };
        };
        
        const aimsScores = calcularScoresAIMS(aimsDetalhada.itens_marcados);
        const aimsResultado = aimsScores.total > 0 && aimsIdadeMeses > 0 
        ...
        const toggleItemAIMS = (itemId: string) => {
          ...
          const novoResultado = novosScores.total > 0 && aimsIdadeMeses > 0
        ...
        const marcarTodosAteIdade = (idadeLimite: number) => {
          const novosItens: Record<string, boolean> = { ...aimsDetalhada.itens_marcados };
          [...AIMS_ITENS_PRONO, ...AIMS_ITENS_SUPINO, ...AIMS_ITENS_SENTADO, ...AIMS_ITENS_EM_PE].forEach(item => {
        ...
        const renderSubescala = (
          ...
          <details className="bg-white dark:bg-gray-800 border rounded-lg" open>
            <summary className={cn('p-3 cursor-pointer font-semibold flex items-center justify-between', cor)}>
              <span>{emoji} {titulo}</span>
              <Badge className="bg-gray-900 text-white">{scoreAtual}/{itens.length}</Badge>
            </summary>
            <div className="p-3 pt-0">
              <div className="grid grid-cols-1 gap-1 mt-2">
                {itens.map((item) => {
                  const isChecked = aimsDetalhada.itens_marcados[item.id] || false;
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-500">~{item.idade_tipica_meses}m</span>
                          {isEsperado && !isChecked && (
                            <span className="text-xs text-yellow-600 bg-yellow-100 px-1 rounded">esperado</span>
                          )}
                        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
              <div className="flex items-start gap-2">
                <Info className="h-5 w-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                <div>
                  <h4 className="font-semibold text-blue-900 dark:text-blue-100">AIMS - Alberta Infant Motor Scale</h4>
                  <p className="text-sm text-blue-700 dark:text-blue-300 mt-1">
                    Marque cada item que o bebê demonstrar espontaneamente. Os scores são calculados automaticamente.
                    Idade do paciente: <strong>{aimsIdadeMeses} meses</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            {!isReadOnly && (
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-300 rounded-lg p-3">
                <h5 className="font-semibold text-yellow-800 dark:text-yellow-200 mb-2 text-sm">⚡ Ações Rápidas</h5>
                <p className="text-xs text-yellow-700 dark:text-yellow-300 mb-2">
                  Marque automaticamente todos os itens esperados para bebês mais novos que a idade selecionada:
                </p>
                <div className="flex flex-wrap gap-2">
            ...
            <div className={cn(
              ...
              <div className="grid grid-cols-2 md:grid-cols-6 gap-3 text-center">
                <div>
                  ...
                  <p className="font-bold text-lg text-orange-600">{aimsScores.prono}/21</p>
                </div>
                <div>
                  <span className="text-xs text-gray-500">🔷 Supino</span>
                  <p className="font-bold text-lg text-blue-600">{aimsScores.supino}/9</p>
                </div>
                <div>
                  <span className="text-xs text-gray-500">🟢 Sentado</span>
                  <p className="font-bold text-lg text-green-600">{aimsScores.sentado}/12</p>
                </div>
                <div>
                  <span className="text-xs text-gray-500">🔴 Em Pé</span>
                  <p className="font-bold text-lg text-red-600">{aimsScores.em_pe}/16</p>
                </div>
                ...
                <div className="border-l pl-3">
                  ...
                  {aimsResultado ? (
                    <Badge className={cn('text-white mt-1', getCorClassificacaoAIMS(aimsResultado.classificacao))}>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2">
                    <div 
                      className={cn(
                        ...
                        aimsResultado?.classificacao === 'atipico' ? 'bg-red-500' 
                        : aimsResultado?.classificacao === 'suspeito' ? 'bg-yellow-500' 
                        : 'bg-green-500'
                      )}
                      style={{ width: `${Math.min((aimsScores.total / 58) * 100, 100)}%` }}
                    />
                  </div>
                </div>
              )}
            ...
            <div className="space-y-3">
              {renderSubescala('PRONO (De bruços)', '🔶', 'text-orange-700 dark:text-orange-300', AIMS_ITENS_PRONO, aimsScores.prono)}
              {renderSubescala('SUPINO (Barriga para cima)', '🔷', 'text-blue-700 dark:text-blue-300', AIMS_ITENS_SUPINO, aimsScores.supino)}
              {renderSubescala('SENTADO', '🟢', 'text-green-700 dark:text-green-300', AIMS_ITENS_SENTADO, aimsScores.sentado)}
              {renderSubescala('EM PÉ', '🔴', 'text-red-700 dark:text-red-300', AIMS_ITENS_EM_PE, aimsScores.em_pe)}
            </div>
            ...
            {aimsScores.total > 0 && (
              <div className={cn(
                ...
                <h4 className="font-semibold mb-3 flex items-center gap-2">
                  <CheckCircle2 className={cn(
                    'h-5 w-5',
                    aimsResultado?.classificacao === 'atipico' ? 'text-red-600' 
                    : aimsResultado?.classificacao === 'suspeito' ? 'text-yellow-600' 
                    : 'text-green-600'
                  )} />
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div>
                    <span className="text-xs text-gray-500">Percentil</span>
                    <div className="flex items-center gap-2">
                      <p className="font-bold text-2xl">{aimsResultado?.percentil || '-'}%</p>
                    </div>
                  </div>
                  <div>
                    <span className="text-xs text-gray-500">Classificação</span>
                    <Badge className={cn('text-white mt-1', getCorClassificacaoAIMS(aimsResultado?.classificacao))}>
                      {aimsResultado?.classificacao === 'atipico' && '⚠️ Atípico'}
                      {aimsResultado?.classificacao === 'suspeito' && '⚡ Suspeito'}
                ...
                {aimsResultado?.classificacao === 'atipico' && (
                  <div className="mt-4 pt-3 border-t border-current/20">
                    <p className="text-sm flex items-start gap-2">
                      ...
                      <span>
                        <strong>Desenvolvimento Atípico (Percentil ≤5%):</strong> Indica possível atraso motor significativo.
                        Recomenda-se avaliação neurológica complementar e intensificação da estimulação.
                      </span>
                    </p>
                  </div>
                )}
                {aimsResultado?.classificacao === 'suspeito' && (
                  <div className="mt-4 pt-3 border-t border-current/20">
                    <p className="text-sm flex items-start gap-2">
                      <AlertTriangle className="h-4 w-4 mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Desenvolvimento Suspeito (Percentil 6-10%):</strong> Monitorar de perto.
                        Reavaliar em 4-6 semanas para confirmar ou descartar atraso.
                      </span>
                    </p>
                  </div>
                )}
            ...
            <details className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg" open={aimsScores.total > 0}>
              ...
              <div className="p-4 pt-0 space-y-3 text-sm">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="bg-white dark:bg-gray-800 p-3 rounded-lg border-l-4 border-green-500">
                    <h5 className="font-semibold text-green-700 dark:text-green-300">✅ Normal (P {'>'} 10%)</h5>
                  ...
                  <div className="bg-white dark:bg-gray-800 p-3 rounded-lg border-l-4 border-yellow-500">
                    <h5 className="font-semibold text-yellow-700 dark:text-yellow-300">⚡ Suspeito (P 6-10%)</h5>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                      Zona de alerta. Reavaliar em 4-6 semanas.
                      Orientar estimulação motora mais intensiva em casa.
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 p-3 rounded-lg border-l-4 border-red-500">
                    <h5 className="font-semibold text-red-700 dark:text-red-300">⚠️ Atípico (P ≤ 5%)</h5>
                    <p className="text-xs text-gray-600 dark:text-gray-400 mt-1">
                      Atraso motor significativo. Investigar causas.
                      Considerar avaliação neurológica e intervenção precoce.
                    </p>
                  </div>
                </div>

                <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg text-xs">
                  <h5 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">💬 Como comunicar aos pais:</h5>
                  <ul className="space-y-1 text-blue-700 dark:text-blue-300 list-disc list-inside">
                    <li><strong>Normal:</strong> "O desenvolvimento motor do bebê está adequado para a idade."</li>
                    <li><strong>Suspeito:</strong> "Vamos acompanhar mais de perto e intensificar os exercícios em casa."</li>
                    <li><strong>Atípico:</strong> "Identificamos alguns pontos que precisam de atenção. Vamos trabalhar juntos e fazer avaliações complementares."</li>
                  </ul>
                </div>
              </div>
            </details>
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="p-2 bg-blue-50 dark:bg-blue-900/20">P50</th>
                      <th className="p-2">P75</th>
                      <th className="p-2">P90</th>
                    </tr>
                  </thead>
                  <tbody>
                    {AIMS_REFERENCIA_PERCENTIL.filter(r => r.idade_meses <= 12).map((ref) => (
                      <tr key={ref.idade_meses} className={cn(
                        'border-b',
                        Math.abs(ref.idade_meses - aimsIdadeMeses) < 0.5 && 'bg-yellow-50 dark:bg-yellow-900/20 font-bold'
                      )}>
                        <td className="p-2">{ref.idade_meses}m</td>
                        <td className="p-2 text-center text-red-600">{ref.p5}</td>
                        <td className="p-2 text-center text-yellow-600">{ref.p10}</td>
                        <td className="p-2 text-center">{ref.p25}</td>
                        <td className="p-2 text-center bg-blue-50 dark:bg-blue-900/20">{ref.p50}</td>
                        <td className="p-2 text-center">{ref.p75}</td>
                        <td className="p-2 text-center text-green-600">{ref.p90}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
                <p className="text-xs text-gray-500 mt-2">
                  Valores de referência baseados em Piper & Darrah (1994). P5 = Percentil 5 (atípico), P50 = Percentil 50 (mediana).
                </p>
              </div>
            </details>
            ...
            <details className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded-lg">
              ...
              <div className="p-4 pt-0 text-xs space-y-2 text-orange-800 dark:text-orange-200">
                <p>• <strong>Ambiente:</strong> Superfície firme, temperatura agradável, bebê só de fralda</p>
                <p>• <strong>Timing:</strong> Após alimentação (30-60 min), bebê alerta e calmo</p>
                <p>• <strong>Materiais:</strong> Brinquedos coloridos, sonoros, de fácil preensão</p>
                <p>• <strong>Prematuros:</strong> Use a idade corrigida até os 2 anos</p>
                <p>• <strong>Documentação:</strong> Filme trechos para comparação futura</p>
                <p>• <strong>Repetição:</strong> Se em dúvida sobre um item, observe novamente em outra sessão</p>
              </div>
            </details>
          </div>
        );
      ...
      case 'severidade':
        ...
        const temNoduloSev = !!(
          (torcicoloSev?.ecom_direito_nodulo && torcicoloSev.ecom_direito_nodulo !== 'ausente') || 
          (torcicoloSev?.ecom_esquerdo_nodulo && torcicoloSev.ecom_esquerdo_nodulo !== 'ausente')
        );
        ...
        const temDadosGoniometria = gonioSev?.rotacao && (
          gonioSev.rotacao.passiva_direita !== undefined || 
          gonioSev.rotacao.passiva_esquerda !== undefined
        );
        const temDadosTorcicolo = torcicoloSev?.tipo_clinico !== undefined || avaliacao.tem_torcicolo !== undefined;
        const dadosSuficientes = temDadosGoniometria || temDadosTorcicolo || temNoduloSev;
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-800 dark:text-purple-200">
                    O grau de severidade é calculado automaticamente baseado nos dados coletados:
                  </p>
                  <ul className="mt-2 text-xs text-purple-700 dark:text-purple-300 space-y-1">
                    <li>• <strong>Idade:</strong> {patientAgeInMonths || 0} meses</li>
                    <li>• <strong>Déficit de Rotação:</strong> {deficitRotacaoSev}° (da Goniometria)</li>
                    <li>• <strong>Nódulo:</strong> {temNoduloSev ? 'Presente' : 'Ausente'} (da Palpação)</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            {dadosSuficientes ? (
              <div className={cn(
                ...
                <div className="text-xl font-semibold mb-1">
                  GRAU {severidadeCalc.grau} - {severidadeCalc.titulo.toUpperCase()}
                </div>
                <div className="text-sm opacity-90 mb-4">
                  Grupo: {severidadeCalc.grupo === 'precoce' ? 'Precoce (0-6m)' : 
                          severidadeCalc.grupo === 'tardio' ? 'Tardio (7-12m)' : 
                          'Muito Tardio (>12m)'}
                </div>
                
                {/* Critérios utilizados */}
                <div className="mt-4 p-3 bg-black/10 rounded-lg text-left">
                  <p className="text-xs font-semibold mb-2">📋 Critérios utilizados:</p>
                  <ul className="text-xs space-y-1 opacity-90">
                    <li>• Faixa etária: {severidadeCalc.criterios.idade_grupo}</li>
                    <li>• Déficit de rotação: {severidadeCalc.criterios.deficit_rotacao}</li>
                    <li>• Nódulo: {severidadeCalc.criterios.nodulo ? 'Presente' : 'Ausente'}</li>
                  </ul>
                </div>
                
                {/* Prognóstico */}
                <div className="mt-4 p-4 bg-white/20 rounded-lg">
                  <p className="text-sm font-bold mb-1">⏱️ Prognóstico Estimado</p>
                  <p className="text-2xl font-bold">
                    {severidadeCalc.prognostico.min_meses} a {severidadeCalc.prognostico.max_meses} meses
                  </p>
            ...
            <details className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border">
              ...
              <div className="p-4 pt-0">
                ...
                <div className="mt-3 p-2 bg-red-50 dark:bg-red-900/20 rounded text-xs">
                  <strong className="text-red-700 dark:text-red-400">🔴 Grau 8 - Muito Tardio:</strong> 
                  <span className="text-red-600 dark:text-red-300"> Qualquer caso após 12 meses.</span>
                </div>
              </div>
            </details>
        ...
        return (
          <Field label="Exames Complementares">
            <EvolutionEditor
              ...
              onChange={(value) =>
                onChange({ exames_complementares: value })
              }
              disabled={isReadOnly}
      ...
      case 'diagnostico':
        ...
        const handleGerarDiagnostico = () => {
          onChange({ diagnostico_cinetico_funcional: diagnosticoGerado.texto_completo });
        };
        ...
        return (
          <div className="space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-800 dark:text-emerald-200">
                    O sistema pode gerar automaticamente um texto de diagnóstico cinético-funcional 
                    baseado em todas as informações coletadas nesta avaliação. Você pode revisar e 
            ...
            <details className="bg-gray-50 dark:bg-gray-800/50 rounded-lg border" open>
              ...
              <div className="p-4 pt-2 space-y-3 text-sm">
                {Object.entries(diagnosticoGerado.secoes).map(([key, value]) => {
                  ...
                  return (
                    <div key={key} className="p-2 bg-white dark:bg-gray-700 rounded border-l-4 border-emerald-500">
                ...
                {diagnosticoGerado.tags_detectadas.length > 0 && (
                  <div className="pt-3 border-t">
                    <p className="text-xs font-medium text-gray-500 mb-2">🏷️ Tags Clínicas Detectadas:</p>
                    <div className="flex flex-wrap gap-1">
                      {diagnosticoGerado.tags_detectadas.map((tag, i) => (
                        <span key={i} className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300 text-xs rounded">
                          {tag}
                        </span>
                      ))}
                    </div>
