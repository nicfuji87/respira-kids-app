...
| 0.2 | Remover `document_storage_anon_crud`                                                                                                                                                                     | migration                                                                         | ⬜                 |
| 0.3 | Rotacionar a chave da OpenAI (esteve exposta)                                                                                                                                                            | painel OpenAI + `api_keys`                                                        | ⬜ decisão do dono |
| 0.4 | Criar bucket **privado** `respira-financeiro` (PDF/XML/JPG/PNG, 10 MB) + policies                                                                                                                        | migration                                                                         | ⬜                 |
| 0.5 | Migrar os 4 anexos existentes e trocar `publicUrl` por signed URL                                                                                                                                        | `LancamentoForm.tsx`, `LancamentoList.tsx`                                        | ⬜                 |
